 ...
 * Dibujado ESCALADO (celda nativa de 20px reducida/ampliada al vuelo al tamaño pedido, mismo
 * truco de blit con tamaño de destino != tamaño de origen que ya usa `TechniqueIcons.blit`): el
 * downscale/upscale en pantalla no pierde nitidez porque lo hace el propio motor. Tamaño
 * configurable (constructor de 3 args) porque este mismo botón sirve tanto para el preview de
 * sonido del editor (12px, hueco angosto) como para reemplazar botones "Start"/"Begin" enteros
 * en las pantallas de Training (bastante más grande, es la acción principal de la pantalla) —
 * pedido explícito del usuario para Shadow/Meditation, reusando el ícono en vez de dibujar uno
 * nuevo por caso de uso. Sin textura de hover propia (el atlas no tiene variante _highlight): el
 * brillo al pasar el ratón sale de teñir el propio blit, mismo lenguaje que ya usa
 * AtlasIconButton para cualquier otro icono suelto de este atlas.
 */
public class PlayIconButton extends AbstractButton {
    ...
    public PlayIconButton(int x, int y, int size, Runnable onClick) {
