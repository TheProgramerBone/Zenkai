...
public class GeoLayerArmorItem extends ArmorItem implements GeoItem {
    ...
    public GeoLayerArmorItem(Holder<ArmorMaterial> material, Type type, Properties properties,
        ...
        this.modelPath     = ResourceLocation.fromNamespaceAndPath(DragonBlockRenewed.MOD_ID, modelPath);
        this.texturePath   = ResourceLocation.fromNamespaceAndPath(DragonBlockRenewed.MOD_ID, texturePath);
        this.animationPath = ResourceLocation.fromNamespaceAndPath(DragonBlockRenewed.MOD_ID, animationPath);
    }
