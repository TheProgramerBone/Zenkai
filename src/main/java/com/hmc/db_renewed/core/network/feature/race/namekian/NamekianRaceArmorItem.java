...
public class NamekianRaceArmorItem extends ArmorItem implements GeoItem {
    public NamekianRaceArmorItem(Holder<ArmorMaterial> material, Type type, Properties properties) {
